...
const fetchCities = async () => {
  try {
    const response = await axios.get('http://3.26.59.191:5001/location/getCities');
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      ...
      if (compareImage !== userData.profileImage) {
        ...
        await axios.patch('http://3.26.59.191:5001/user/updateImage', { userId: userData._id, url: url });
      }
