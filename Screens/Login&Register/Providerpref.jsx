...
export default function ProviderPreferencePage ({navigation, route, props}) {
   ...
   ;
    ...
    const fetchServices = async () => {
        try {
            const response = await axios.get('http://3.107.4.155:5001/service/getServices');
    ...
    const saveTempDetails = async () => {
        try{
            ...
            await axios.post("http://3.107.4.155:5001/user/addTempDetails", userData).then(async (res) => {
