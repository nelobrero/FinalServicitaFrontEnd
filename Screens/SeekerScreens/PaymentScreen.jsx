  ...
  // };
    ...
    const handleContinue = async () => {
      ...
      const paymentData = {
        ...
        redirect: {
          success: "http://3.26.234.99:5000/payment/success",
          failed: "http://3.26.234.99:5000/payment/failed",
        }
      }
      try {
        const response = await axios.post('http://3.26.234.99:5000/payment/initiatePayment', paymentData);
