  ...
  // };
    ...
    const handleContinue = async () => {
      ...
      const paymentData = {
        ...
        redirect: {
          success: "http://3.107.4.155:5001/payment/success",
          failed: "http://3.107.4.155:5001/payment/failed",
        }
      }
      try {
        const response = await axios.post('http://3.107.4.155:5001/payment/initiatePayment', paymentData);
