...
const AIScreen = ({ route }) => {
  ...
  const submitHandler = async () => {
    ...
    try {
      ...
      const response =
        userRole === "Seeker"
          ? await axios.post("http://192.168.1.6:5001/ai/generateSeekerContent", { inputText: inputMessage })
          : await axios.post("http://192.168.1.6:5001/ai/generateProviderContent", { inputText: inputMessage });
