...
// const AIScreen = ({ navigation, role }) => {
  ...
  const submitHandler = async () => {
    ...
    try {
      ...
      const response = role === "Seeker" ? await axios.post("http://3.26.234.99:5000/ai/generateSeekerContent", { inputText: inputMessage }) : await axios.post("http://3.26.234.99:5000/ai/generateProviderContent", { inputText: inputMessage })
